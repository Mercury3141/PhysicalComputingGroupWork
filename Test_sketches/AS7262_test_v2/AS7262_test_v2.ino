...
//  Serial.print(" Violet: "); Serial.print(sensorValues[AS726x_VIOLET]);
  Serial.print(""); Serial.print(filtering(sensorValues[AS726x_BLUE]));
...
float filtering (float raw_value){
  if (raw_value > current_output) {
    current_output  = alpha_up*raw_value + (1-alpha_up)*previous_output;
  }
  else {
    current_output  = alpha_down*raw_value + (1-alpha_down)*previous_output;
  }
